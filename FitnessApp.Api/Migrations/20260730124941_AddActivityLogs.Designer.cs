...
namespace FitnessApp.Api.Migrations
{
    ...
    [Migration("20260730124941_AddActivityLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Api.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Api.Models.MealPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Api.Models.MealPlanMeal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MealPlanId", "DisplayOrder")
                        .IsUnique();
            ...
            modelBuilder.Entity("FitnessApp.Api.Models.PersonalRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "ExerciseId", "RecordDate");
            ...
            modelBuilder.Entity("FitnessApp.Api.Models.MealPlanMeal", b =>
                {
                    b.HasOne("FitnessApp.Api.Models.Meal", "Meal")
                        .WithMany("MealPlanMeals")
                        .HasForeignKey("MealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FitnessApp.Api.Models.MealPlan", "MealPlan")
                        .WithMany("MealPlanMeals")
